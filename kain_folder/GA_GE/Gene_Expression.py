...
for i in range(iter):
    e, X, t = gillespie(init, rates,
                        genesub, genepro,
                        tmax)
    stored_val[i, ] = [X[-1, 1], X[-1, 2]]
